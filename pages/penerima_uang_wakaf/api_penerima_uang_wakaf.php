<?php
    ...
    $key = isset($_REQUEST['id_penerima_manfaat_wakaf']) ? $_REQUEST['id_penerima_manfaat_wakaf'] : '';
    
		$nama_penerima= isset($_REQUEST['nama_penerima']) ? $_REQUEST['nama_penerima'] : '' ;
		$nama_institusi_penerima= isset($_REQUEST['nama_institusi_penerima']) ? $_REQUEST['nama_institusi_penerima'] : '' ;
    ...
    switch ($method) {
        case 'GET':
          $sql = "SELECT * FROM penerima_uang_wakaf ".($key ?" WHERE id_penerima_manfaat_wakaf =$key":''); 
        break;
        case 'PUT': $sql = "UPDATE penerima_uang_wakaf SET 
										...
										kode_pos= '$kode_pos', 
										provinsi= '$provinsi' WHERE id_penerima_manfaat_wakaf = $key ";
        break;
        case 'POST': $sql = "INSERT INTO penerima_uang_wakaf( 
										nama_penerima, 
        ...
        break;
        case 'DELETE':
           $sql = "DELETE FROM penerima_uang_wakaf WHERE id_penerima_manfaat_wakaf = $key"; 
        break;
    }       
